...
public class Mechanical extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        year = findViewById(R.id.mechanical_spinner_attendance_year);
        division = findViewById(R.id.mechanical_spinner_attendance_division);
        submit = findViewById(R.id.submit_attendance);
        date = findViewById(R.id.date);
        subject = findViewById(R.id.mechanical_spinner_attendance_subject);
