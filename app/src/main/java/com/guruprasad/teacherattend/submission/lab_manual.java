...
public class lab_manual extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submit = findViewById(R.id.submit_labmanual);
    ...
    public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(getApplicationContext(),lab_manual_submission_activity.class);
