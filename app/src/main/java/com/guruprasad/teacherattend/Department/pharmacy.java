...
public class pharmacy extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    Spinner year , div ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Objects.requireNonNull(getSupportActionBar()).setTitle("Pharmacy Department ");
        ...
        recyclerView = findViewById(R.id.pharmacy_rec);
    ...
    public void display_student()
    {
        ...
        FirebaseRecyclerOptions<student_model> options = new FirebaseRecyclerOptions.Builder<student_model>().setQuery(FirebaseDatabase.getInstance().
                getReference("Students").child("Pharmacy").child(Year).child(division), student_model.class).build();
