...
public class e_and_tc extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    Spinner year , div ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eand_tc);
        Objects.requireNonNull(getSupportActionBar()).setTitle("E and TC Department ");
        ...
        recyclerView = findViewById(R.id.e_and_tc_rec);
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(e_and_tc.this));
    ...
    public void display_student()
    {
        ...
        FirebaseRecyclerOptions<student_model> options = new FirebaseRecyclerOptions.Builder<student_model>().setQuery(FirebaseDatabase.getInstance().
                getReference("Students").child("E and TC").child(Year).child(division), student_model.class).build();
