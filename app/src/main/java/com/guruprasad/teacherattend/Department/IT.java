...
public class IT extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Objects.requireNonNull(getSupportActionBar()).setTitle("IT Department ");
        ...
        recyclerView = findViewById(R.id.it_rec);
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(IT.this));
    ...
    public void display_student()
    {
        ...
        FirebaseRecyclerOptions<student_model> options = new FirebaseRecyclerOptions.Builder<student_model>().setQuery(FirebaseDatabase.getInstance().
                getReference("Students").child("IT").child(Year).child(division), student_model.class).build();
